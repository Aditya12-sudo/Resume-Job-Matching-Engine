            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              >
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-10 h-12 border-gray-200 focus:border-purple-500 transition-colors"
                    required
                  />
                  <button
                    type="button"
              ...
              >
                <Button
                  type="submit"
                  disabled={isLoading}
                  className="w-full h-12 bg-gradient-to-r from-purple-500 to-blue-600 hover:from-purple-600 hover:to-blue-700 text-white font-medium transition-all duration-200 transform hover:scale-[1.02]"
                >
                  {isLoading ? (
                    <motion.div
                      animate={{ rotate: 360 }}
